#ifndef HLT_SOCKET_DEMO_H
#define HLT_SOCKET_DEMO_H
...
//    void SetTestUserData(DetectorPageUserData sDetectorPageUserDataStruct);
    ...
    sendThread* create_thread_cnt();
    void delete_thread_cnt();
    // NOTE: 从public中拿到的函数
...
//    DataBaseQuery mQuery_get;


};
#endif // HLT_SOCKET_DEMO_H
